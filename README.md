...
| **Retrieve a ticket**    | `GET`       | `/tickets/{ticket_id}`     | Retrieve a ticket by ID    |
| **Update a ticket**      | `PUT`       | `/tickets/{ticket_id}`     | Update a ticket by ID      |
| **Delete a ticket**      | `DELETE`    | `/tickets/{ticket_id}`     | Delete a ticket by ID      |
